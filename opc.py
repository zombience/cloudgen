...
class Client(object):
    ...
    def put_bytes(self, pixel_bytes, channel=0):
        """ bypass the re-packing of bytes in put_pixels
            accounting for sending pixels from C#, where byte packing
            is better done on the sending end
        """
        self._debug('put_bytes: connecting')
